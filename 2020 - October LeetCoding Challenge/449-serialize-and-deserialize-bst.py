# Question: https://leetcode.com/explore/challenge/card/october-leetcoding-challenge/560/week-2-october-8th-october-14th/3489/
...
class Codec:
    ...
    def deserialize(self, data: str) -> TreeNode:
        ...
        return dfs(data.split(",")[:len(data)-1])
