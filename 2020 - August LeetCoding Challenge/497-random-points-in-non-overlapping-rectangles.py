# Question: https://leetcode.com/explore/featured/card/august-leetcoding-challenge/552/week-4-august-22nd-august-28th/3433/
...
class Solution:
    ...
    def __init__(self, rects: List[List[int]]):
        ...
        self.weights = [point/sum(self.points) for point in self.points]
        

    def pick(self) -> List[int]:
        rect = random.choices(self.rects, weights=self.weights, k=1)
        x1, y1, x2, y2 = rect[0]
